...
\zack{I guess in this chapter, we are only interested in controls where $\pi_t$ is a function of the current state alone,
...
\section{Entropy-Regularized Gibbs Optimizer}
