...
growth, we exploit the structure of the underlying stochastic processes to obtain
...
our understanding of coalescence under the multispecies coalescent model and develops new asymptotics for these bounds
and absorption times under Kingman's coalescent in the natural short branch regime.


% Self-Balancing Sampling
\noindent In Chapter 2, in joint work with Daniel Raban we study a family of sequential sampling rules 
that adaptively bias sampling probabilities in order to achieve faster convergence of the empirical distribution 
to a desired target law, while keeping the resulting samples as unpredictable as possible. Such trade-offs arise naturally 
in compliance-testing settings, including health inspections and anti-doping programs. The resulting scheme 
...
as measured by an adversarial prediction accuracy.

% Inference under the PCH model
\noindent In Chapter 3, we study phylogenetic inference under the 
...
% Exchangeable arrays
Lastly, in Chapter 4, we connect the modern theory of hypergraphons to the classical theory of exchangeable arrays
...
\cite{grubel2015_persisting_randomness_graphs_search_trees,grubel2023_ranks_copulas_permutons}. Lastly, we
characterize the limiting objects in terms of a natural ergodicity condition.
