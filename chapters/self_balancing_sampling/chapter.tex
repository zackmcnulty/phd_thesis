...
Lastly, we study the trade-off between predictability and the convergence rate. As discussed in the previous two sections, we quantify the former using the adversaries prediction accuracy, and the latter using the limit $\lim_{n\to \infty} n d_n$. Figure \ref{fig:trade_off} highlights the results.  
