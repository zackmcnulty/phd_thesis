...
computation of many quantites of interest.
 ...
 Firstly we will develop a metric for binary arrays and latter 
 we will discuss how it can be extended to any exchangeable array process. 
 As discussed in Corollary~\ref{cor:classification_binary_array_processes} above, $d$-dimensional binary arrays are essentially just $d$-uniform hypergraph chains. Thus, we can view this first section as extending the cut metric to $d$-uniform hypergraphs, as in \cite{elek2007_limits_hypergraphs_regularity_lemmas}.
